...
export function CadUsuario() {
    ...
    const handleEmailChange = (e) => {
        ...
        const [localPart, domainPart] = valor.split("@");
    if (localPart) {
        valor = localPart.replace(/[^a-zA-Z0-9._]/g, "") + (domainPart ? "@" + domainPart : "");}
        if (valor.length > 30) valor = valor.slice(0, 30); // máximo 50 chars
