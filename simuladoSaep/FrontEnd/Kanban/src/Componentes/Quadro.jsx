...
export function Quadro(){
    ...
    useEffect (() => {
        ...
        .catch(error => {console.error("Deu ruim hein")});
    },[])
        //
        const tarefasAfazer = tarefas.filter(tarefa => tarefas.status === "A fazer");
        const tarefasFazendo = tarefas.filter(tarefa => tarefas.status === "Fazendo");
        const tarefasPronto = tarefas.filter(tarefa => tarefas.status === "Pronto");
